...
int main(void) {
  // you should run every test alone this is because we are using static variables
  // so using static variables is not good for testing
  //emptyString();
  //singleWord();
  //manyWords();
